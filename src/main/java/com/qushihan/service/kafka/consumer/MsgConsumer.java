package com.qushihan.service.kafka.consumer;
...
public class MsgConsumer {
    ...
    public synchronized List<Message> consumerMsg(int uid) {// uid为本贴id
        List<Message> result = new ArrayList<>();
        KafkaConsumer<String, String> consumer = this.createConsumer();
        consumer.subscribe(Arrays.asList("reply" + uid));
        synchronized (this) {
            ConsumerRecords<String, String> records = consumer.poll(100); // 拉取超时毫秒数
