<div class="modal hide fade" id="register">
    ...
    <div class="modal-body" data-backdrop="static">
        <div class="cnt_b">
            <form method="post" action="/user/reg" name="File_form" method="post" enctype="multipart/form-data"
                  id="File_form">
                <div class="formRow">
                            ...
                            <div class="controls">
                                <div data-fileupload="image"
                                    ...
                                    <div style="width: 60px; height: 60px;" class="fileupload-new thumbnail">
                                        <img src="${sc}/upload/cuy.jpg" name="portrait" id="portrait" alt="请选择自己的头像"/>
                                    </div>
                    ...
                    <div class="control-group formSep">
                        <div class="controls">
                            <div class="alert alert-info">
                                ...
                                <input type="text" id="u_fname" name="reusername"
                                       class="input-xlarge" placeholder="英文或数字" onblur="judgeusername(this.value)"/>
                                <strong>账号 </strong>
                                请认真填写！
                            </div>
                        </div>
        ...
        <div class="modal-footer">
            <button class="btn btn-inverse pull-right" type="button" onclick="register()">注册</button>
        </div>
    </div>
</div>
